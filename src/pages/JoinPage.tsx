    ...
    <div className="min-h-screen bg-[#111114] flex items-center justify-center p-6">
      <div className="w-full max-w-sm text-center space-y-4">
        ...
        <div className="mb-6">
          ...
          <p className="text-xs text-zinc-500 tracking-[0.2em] uppercase mt-0.5">Campaign Invite</p>
        </div>

        {status === 'joining' && (
          <>
            <div className="w-8 h-8 border-2 border-amber-500/30 border-t-amber-400 rounded-full animate-spin mx-auto" />
            <p className="text-sm text-zinc-400 tracking-wide animate-pulse">Joining campaign…</p>
          </>
        )}
        ...
        {status === 'success' && (
          <>
            ...
            <p className="text-xs text-zinc-500">Redirecting to your campaigns…</p>
          </>
        )}
        ...
        {status === 'already-member' && (
          <>
            <div className="text-3xl">✓</div>
            <p className="text-sm font-semibold text-zinc-200">You're already in this campaign.</p>
            <p className="text-xs text-zinc-500">Redirecting to your campaigns…</p>
          </>
        )}
