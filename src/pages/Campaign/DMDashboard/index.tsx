  ...
  return (
    <div className="min-h-screen bg-[#0F0D0B] p-6">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Invite code */}
        <div className="flex items-center gap-2 mb-6 px-3 py-2 rounded-md bg-stone-800/30 border border-stone-700/20">
          ...
          <button
            type="button"
            onClick={copyLink}
            className="text-[9px] text-stone-600 hover:text-amber-400/70 tracking-wider transition-colors ml-auto"
          >
