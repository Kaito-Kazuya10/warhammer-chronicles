  ...
  return (
    <div className="min-h-screen bg-[#131519] p-6">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Invite code */}
        <div className="flex items-center gap-2 mb-6 px-3 py-2 rounded-md bg-slate-800/30 border border-slate-700/20">
          ...
          <button
            type="button"
            onClick={copyLink}
            className="text-[9px] text-slate-600 hover:text-amber-400/70 tracking-wider transition-colors ml-auto"
          >
