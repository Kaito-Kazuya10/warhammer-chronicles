    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 bg-black/40">
          <div className="w-full max-w-md bg-[#1a1d22] border border-zinc-700/30 rounded-lg shadow-2xl p-4 space-y-3">
            <div className="flex items-center justify-between">
              <h3 className="text-xs text-zinc-400 tracking-widest uppercase">Capture Moment</h3>
              <button onClick={() => setOpen(false)} className="text-zinc-600 hover:text-zinc-300">&times;</button>
            </div>
            ...
            <div className="flex gap-2">
              <select
                ...
                className="bg-zinc-900/50 border border-zinc-700/30 rounded px-2 py-1.5 text-xs text-zinc-400 focus:outline-none flex-1"
              >
                {MOMENT_KINDS.map(k => (
